...
#        htmlPattern: "h1 ~ table",
        ...
        patterns: %{ "urlsuffix": "&filelist=1",
                     ...
                     "categoryPattern": "~r/<td[^>]*?>Type(?<type></.*?)</tr>/su",
                     "genrePattern": "~r/<td[^>]*?>Genre(?<genre></.*?)</tr>/su",
                     "genrePattern2": "~r/(Жанр[^\\w]{1}|Genre[^\\w]{1})(?<genre>.*?)(##|:|\\t|<br|</td|</li)/su",
                     "descriptionPattern": "#description",
                     "sizePattern": "~r/<td[^>]*?>Size(?<size></.*?)</tr>/su",
                     "datePattern": "~r/<td[^>]*?>Added(?<date></.*?)</tr>/su",
...
#        lastPageNumber: 199,
      ...
      %{
        ...
        patterns: %{ "urlsuffix": "",
                     ...
                     "sizePattern": "~r/(<b>Size</b>:|Size:)(?<size>.*?)</tr>/su",
                     "datePattern": "~r/<a href=\"/users.*?</a>\\s*\\(Uploader\\)\\s*@\\s*(?<date>.*?)</su",
      ...
      %{
        ...
        patterns: %{ "urlsuffix": "",
                     ...
                     "imgFromLinkReg": "~r/.*/su",
                     "imgFromLinkPrefix": "",
                     "imgLinkPattern": "imgvisits.com/image",
                     "imgHiddenSelector": "#full_image",
                     "imgHiddenAttr": "style",
                     "imgHiddenPattern": "background-image: url\\('(?<url>.*)'\\);",
                     "imgFilterPattern": ".*(fullr.png|halfr.png|blankr.png|spacer.gif|arrow_hover.png|valid_css|valid_html|\\.php).*",
                     "videoPattern": "~r/youtube.com/embed/(?<tubeid>.*?)\"/su"}
      ...
      %{
        ...
        patterns: %{ "urlsuffix": "#expand",
                     ...
                     "categoryPattern": "~r/<td[^>]*?>\\s*Category\\s*(?<type></.*?)</tr>/su",
                     "genrePattern": "~r/<td[^>]*?>\\s*Genre\\s*(?<genre></.*?)</tr>/su",
                     "genrePattern2": "~r/(Жанр:|Genre:)(?<genre>.*?)(##|:|\\t|<br|</td|</li)/su",
                     "descriptionPattern": "~r/<td[^>]*?>\\s*Description\\s*(?<genre>.*?)Screenshots/su",
                     "sizePattern": "~r/<td[^>]*?>\\s*Size\\s*(?<size>.*?)</tr>/su",
                     "datePattern": "~r/<td[^>]*?>\\s*AddDate\\s*(?<date>.*?)</tr>/su",
                     "torrentDescNameValuePattern": ".table-details tr",
